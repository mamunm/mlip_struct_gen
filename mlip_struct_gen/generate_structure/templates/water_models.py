...
WATER_MODELS = {
    "SPC/E": {
        ...
        "bonds": [
            {"atoms": [0, 1], "length": 1.0000},
            {"atoms": [0, 2], "length": 1.0000}
        ],
        "angles": [
            {"atoms": [1, 0, 2], "angle": 109.47}
        ],
    ...
    "TIP3P": {
        ...
        "bonds": [
            {"atoms": [0, 1], "length": 0.9572},
            {"atoms": [0, 2], "length": 0.9572}
        ],
        "angles": [
            {"atoms": [1, 0, 2], "angle": 104.52}
        ],
        "density": 0.997  # g/cm³ at 25°C
    },
    ...
    "TIP4P": {
        ...
        "atoms": [
            ...
            {"element": "H", "position": [-0.7569, 0.5858, 0.0000], "charge": 0.520},
            {"element": "M", "position": [0.0000, -0.1500, 0.0000], "charge": -1.040}  # Virtual site
        ],
        "bonds": [
            {"atoms": [0, 1], "length": 0.9572},
            {"atoms": [0, 2], "length": 0.9572}
...
def create_water_xyz(model_name: str, output_file: str) -> None:
    ...
    with open(output_file, 'w') as f:
        ...
        for atom in model['atoms']:
            f.write(f"{atom['element']} {atom['position'][0]:.6f} "
...
def create_water_pdb(model_name: str, output_file: str) -> None:
    ...
    with open(output_file, 'w') as f:
        ...
        for atom in model['atoms']:
            ...
            f.write(f"ATOM  {atom_num:5d}  {atom['element']:<3s} HOH A   1    "
...
def calculate_water_molecules(box_size: Tuple[float, float, float], 
                            model_name: str = "SPC/E") -> int:
    """
