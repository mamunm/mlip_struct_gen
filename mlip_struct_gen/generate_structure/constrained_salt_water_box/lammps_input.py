"""LAMMPS input file generation for DeepMD simulation with constrained salt water."""

LAMMPS_TEMPLATE = """# LAMMPS input for DeepMD simulation with constrained salt water
...
def generate_constraint_fixes(
    ...
    # Distance constraints (O-H bonds only - O-O and ion-water now use freeze)
...
def generate_lammps_input(
    ...
    **kwargs,
    ...
    # Generate frozen groups (for O-O and ion-water constraints)
