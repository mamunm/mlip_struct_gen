"""Parameter validation for constrained salt water box generation."""
...
# Valid ion elements for distance constraints
VALID_ION_ELEMENTS = {"Na", "Cl", "K", "Li", "Ca", "Mg", "Br", "Cs"}
VALID_WATER_ELEMENTS = {"O", "H"}
VALID_ELEMENTS = VALID_ION_ELEMENTS | VALID_WATER_ELEMENTS


def validate_parameters(parameters: "ConstrainedSaltWaterBoxParameters") -> None:
    """
    Validate and normalize parameters for constrained salt water box generation.
    ...
    # include_salt_volume validation
    ...
    # Get salt model to determine valid ion elements for this salt
    salt_model = get_salt_model(parameters.salt_type)
    cation_element = salt_model["cation"]["element"]
    anion_element = salt_model["anion"]["element"]
    valid_constraint_elements = VALID_WATER_ELEMENTS | {cation_element, anion_element}
