"""Validation for spring metal-water parameters."""
...
def validate_parameters(params: SpringMetalWaterParameters) -> None:
    """
    Validate spring metal-water parameters.
    ...
    has_constraints = params.metal_water_spring_constraints or params.spring_constraints
