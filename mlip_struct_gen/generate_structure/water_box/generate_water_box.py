    ...
    def run(self, save_artifacts: bool = False) -> str:
        ...
        if n_molecules is None:
            if self.parameters.density is not None:
                ...
                n_molecules = self._calculate_molecules_custom_density(
                    self.parameters.box_size, self.parameters.density
                )
            else:
                ...
                n_molecules = self._calculate_molecules_custom_density(
                    self.parameters.box_size, model_density
                )
        ...
        try:
            ...
            self._create_packmol_input(
                ...
                self.parameters.box_size, n_molecules, 
        ...
        if self.logger:
            self.logger.success(f"Water box generation completed successfully")
