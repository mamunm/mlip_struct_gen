"""LAMMPS input file generation for DeepMD simulation with constraints."""

LAMMPS_TEMPLATE = """# LAMMPS input for DeepMD simulation with constrained water
...
def generate_constraint_fixes(
    ...
    # Distance constraints (O-H bonds and O-O intermolecular)
...
def generate_lammps_input(
    ...
    **kwargs,
    ...
    """
    # Use default elements if not provided
    if elements is None:
        elements = ["O", "H"]
