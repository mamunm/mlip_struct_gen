"""Constrained water box generation."""
...
class ConstrainedWaterBoxGenerator:
    """Generate constrained water boxes for MLIP training."""

    def __init__(self, parameters: ConstrainedWaterBoxParameters):
        """
        Initialize constrained water box generator.
    ...
    def run(self, save_artifacts: bool = False) -> str:
        """
        Generate constrained water box.
        ...
        """
        if self.logger:
            self.logger.info("Starting constrained water box generation")
        ...
        if self.logger:
            self.logger.success("Constrained water box generation completed")
    ...
    def _apply_distance_constraint(self, atoms, molecules, constraint) -> None:
        """Apply a distance constraint (intramolecular or intermolecular)."""
    ...
    def _write_lammps_data(self, atoms, output_path: Path) -> None:
        ...
        with open(output_path, "w") as f:
            f.write("# LAMMPS data file for constrained water box (atomic style for DeepMD)\n")
