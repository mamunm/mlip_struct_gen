...
class MetalWaterLAMMPSParameters:
    ...
    water_model: str = "SPC/E"  # SPC/E, TIP3P, TIP4P/2005

    # Metal potential parameters
    potential_type: str = "eam"  # "eam" or "lj"
    potential_style: str = "eam/alloy"  # eam/alloy, lj/cut, etc.
    potential_file: str | None = None  # Path to potential file (for EAM)
    lj_cutoff: float = 10.0  # LJ cutoff in Angstrom (for LJ)
    ...
    # Advanced settings
    timestep: float = 2.0  # fs (larger for water with SHAKE)
    ...
    compute_centro: bool = False  # Compute centrosymmetry parameter (not useful for interface)
